...
for i = 1: N-1
    ...
    q2(i+1) = q2(i) + h * p2(i);
    q = [q1(i),q2(i)];
    p1(i+1) = p1(i) - h * q1(i)/norm(q)^3;
    p2(i+1) = p2(i) - h * q2(i)/norm(q)^3;
...
figure(1);
plot(q1,q2)
title('Figure 1: Standard Euler''s Method','fontsize',16)
xlabel('q1','fontsize',16)
ylabel('q2','fontsize',16)

figure(2);
plot(t,A);
title('Figure 2: Augular Momentum','fontsize',16)
xlabel('t','fontsize',16)
ylabel('A','fontsize',16)

figure(3);
plot(t,H);
title('Figure 3: Hamitonian','fontsize',16)
xlabel('t','fontsize',16)
